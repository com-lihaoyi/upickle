...
object core extends Module {
  object js extends Cross[CoreJsModule]("2.11.12", "2.12.8")
  ...
  object jvm extends Cross[CoreJvmModule]("2.11.12", "2.12.8")
  ...
  object native extends Cross[CoreNativeModule]("2.11.12")
  class CoreNativeModule(val crossScalaVersion: String) extends CommonNativeModule {
    def artifactName = "upickle-core"
...
object implicits extends Module {
  ...
  object js extends Cross[JsModule]("2.11.12", "2.12.8")
  ...
  object jvm extends Cross[JvmModule]("2.11.12", "2.12.8")
  ...
  object native extends Cross[NativeModule]("2.11.12")

  class NativeModule(val crossScalaVersion: String) extends ImplicitsModule with CommonNativeModule{
...
object upack extends Module {
  ...
  object native extends Cross[NativeModule]("2.11.12")
  class NativeModule(val crossScalaVersion: String) extends CommonNativeModule {
    def moduleDeps = Seq(core.native())
    def artifactName = "upack"
...
object ujson extends Module {
  ...
  object json4s extends Cross[Json4sModule]("2.11.12", "2.12.8")
  ...
  object play extends Cross[PlayModule]("2.11.12", "2.12.8")
...
object upickle extends Module{
  ...
  object native extends Cross[NativeModule]("2.11.12")
  class NativeModule(val crossScalaVersion: String) extends UpickleModule with CommonNativeModule {
