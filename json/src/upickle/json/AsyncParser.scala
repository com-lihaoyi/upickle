 ...
 *       allowed.
 */
final class AsyncParser[J] protected[json](
                                            protected[json] var state: Int,
                                            protected[json] var curr: Int,
                                            protected[json] var stack: List[ObjArrVisitor[_, J]],
 ...
 */
private[json] class AsyncException extends Exception with control.NoStackTrace
